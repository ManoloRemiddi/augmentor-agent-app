...
| Desktop 0.2.10 | Installable preview bundle for Debian 13 amd64; complete public bundle available | Planned next | Planned afterward |
| Browser 0.2.10 | Matching extension and runtime required; included in the complete public bundle | Complete setup not verified | Complete setup not verified |
